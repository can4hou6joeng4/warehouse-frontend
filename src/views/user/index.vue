<template>
    ...
    <el-form class="searchForm">
      ...
      <el-form-item label="用户类型:" style="margin-left: 30px;">
        <el-select v-model="params.userType" placeholder="用户类型" style="width: 120px;" clearable>
          <el-option v-for="role of roleList" :label="role.roleName" :value="role.roleId"
  ...
  <!-- 表格 -->
  <el-table :data="userList" ref="multipleTableRef" @selection-change="handleSelectionChange"
            style="width: 100%; margin-top: 10px;" table-layout="auto" size="large" border stripe id="elTable">
    ...
    <el-table-column label="操作">
      <template #default="props">
        ...
        <el-button type="warning" @click="updateState(props.row)">{{ props.row.userState == "1" ? "禁用" : "启用" }}
        </el-button>
